本来是想自己一边[学习](https://github.com/microsoft/ML-For-Beginners/)一遍翻译，后来发现自己翻译太慢了，同时也看到官网也一直在翻译（但我发现官网的翻译不是很好，不过也能看的懂）。所以我就把官方仓储里的翻译内容整合到我自己的repo了，给后续寻找中文翻译的小伙伴们一个便利。
